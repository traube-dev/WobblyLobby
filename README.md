...
## Installation
See [traube.dev/docs](https://traube.dev/docs.html) for the general BepInEx + mod install walkthrough. No manual `BepInEx.cfg` editing needed - tdToolz protects itself and every mod built on it automatically.
